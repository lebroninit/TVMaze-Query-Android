...
public class TvMazeListAdapter extends RecyclerView.Adapter<TvMazeListAdapter.TvMazeListAdapterViewHolder>{
    ...
    public void onBindViewHolder(@NonNull TvMazeListAdapterViewHolder holder, int position) {
        try {
            ...
            final String summary = show.getString("summary");
            ...
            final String code = externals.getString("imdb");
            //Log.d("DEBUG_TVMAZE", externals + "");
            //Log.d("DEBUG_TVMAZE", code);
            ...
            holder.iv_imdb_logo.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    Intent intent = new Intent(Intent.ACTION_VIEW);
                    intent.setData(Uri.parse("https://www.imdb.com/title/" + code));
                    context.startActivity(intent);
                }
            });
            ...
            holder.tv_media_summary.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View view) {
                    String sum = summary;
                    Log.d("DEBUG",sum);
                    Intent intent = new Intent(context,SummaryActivity.class );
                    intent.putExtra("fullSummary",sum);
                    context.startActivity(intent);
                }
            });
